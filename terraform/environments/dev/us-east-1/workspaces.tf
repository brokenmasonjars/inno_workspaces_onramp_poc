...
########## Workspaces Managed AD ##########
# resource "aws_workspaces_directory" "workspaces_directory_managed_ad" {
#   directory_id = aws_directory_service_directory.workspaces_mad.id
...
#     device_type_zeroclient = var.workspaces_access_properties_devices_type_zeroclient
#   }
...
# resource "aws_workspaces_directory" "workspaces_directory_ad_connector" {
